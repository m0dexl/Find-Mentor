    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentorCategory", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentorForm", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MentorForm_Form_FormId",
                        column: x => x.FormId,
                        principalTable: "Form",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MentorForm_Mentors_MentorId",
                        column: x => x.MentorId,
                        principalTable: "Mentors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MentorCategory_MentorId",
                table: "MentorCategory",
                column: "MentorId");

            migrationBuilder.CreateIndex(
                name: "IX_MentorForm_FormId",
                table: "MentorForm",
                column: "FormId");

            migrationBuilder.CreateIndex(
                name: "IX_MentorForm_MentorId",
                table: "MentorForm",
                column: "MentorId");
